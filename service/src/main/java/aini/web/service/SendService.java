...
public class SendService
{
    ...
    public Boolean sendSms(StudentVO student)
    {
        ...
        try
        {
            ...
            String msg = base64Encode(nullcheck(getContent(this.smsContent, student), ""));                  // 메시지
            String rphone = base64Encode(nullcheck(student.getPhoneNumber(), ""));      // 받는번호
        ...
        logger.info("Phone : " + student.getPhoneNumber());
        logger.info("");
    ...
    public Boolean sendEmail(StudentVO student)
    {
        ...
        try
        {
            ...
            msg.setRecipient(Message.RecipientType.TO, new InternetAddress(student.getEmailAddress()));
            msg.setSubject(getContent(this.mailSubject, student));
            msg.setSentDate(new Date());

            // 내용
            BodyPart bp1 = new MimeBodyPart();
            bp1.setText(getContent(this.mailContent, student));
        ...
        logger.info("Name : " + student.getName());
        logger.info("Email : " + student.getEmailAddress());
        logger.info("");
