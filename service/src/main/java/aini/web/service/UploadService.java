            ...
            try
            {
                ...
                while (itr.hasNext())
                {
                    ...
                    try
                    {
                        ...
                        String name = workSheet.getCells().get(5, 3).getStringValue();
                        String emailAddress = workSheet.getCells().get(5, 19).getStringValue();
                        String phoneNumber = workSheet.getCells().get(5, 27).getStringValue();
