...
public class CommonController
{
     ...
     */
    @RequestMapping(value = "/report/{phoneNumber}", method = RequestMethod.GET)
    public String reportRedirect(@PathVariable("phoneNumber") String phoneNumber, Model model, HttpServletRequest request)
    {
     ...
     * @create-date : 2017. 2. 26.
     */
    @RequestMapping(value = "/report/check/{phoneNumber}/{authNumber}", method = RequestMethod.GET)
    @ResponseBody
    public String reportCheck(@PathVariable("phoneNumber") String phoneNumber, @PathVariable("authNumber") String authNumber, HttpServletRequest request, HttpServletResponse response) throws IOException
    {
        ...
        {
            File dir = new File(request.getSession().getServletContext().getRealPath("/") + "/upload/pdf/");
     ...
     * @create-date : 2017. 2. 16.
     */
    @RequestMapping(value = "/report/get/{fileName}", method = RequestMethod.GET)
    public void report(@PathVariable("fileName") String fileName, HttpServletRequest request, HttpServletResponse response) throws IOException
    {
        ...
        {
            // PDF 파일 조회
            File pdfFile = new File(request.getSession().getServletContext().getRealPath("/") + "/upload/pdf/" + fileName + ".pdf");
